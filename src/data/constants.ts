...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Building practical systems with Java, object-oriented design, MySQL, and clean interfaces.",
      "Created attendance, library, and university admission projects from requirements to working software.",
      "Continuously expanding into TypeScript, Node.js, Spring Boot, and full-stack development.",
      "Practicing maintainable code, database design, version control, and problem solving.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.TS,
  ...
  },
  {
    ...
    description: [
      "Java and object-oriented programming for practical desktop and backend systems.",
      "MySQL database design, queries, relationships, and application data workflows.",
      "C and C++ fundamentals, TypeScript, JavaScript, Node.js, and Git/GitHub.",
      "Currently learning Spring Boot, full-stack development, and AI integration patterns.",
    ],
    skills: [
      SkillNames.NODEJS,
      SkillNames.JS,
